import { SubsectionHeading } from "@/primals";

# SubsectionHeading Component

The `SubsectionHeading` component is a functional component that returns a subsection heading element with various style properties.

## Props

The `SubsectionHeading` component accepts the following props:
...
<SubsectionHeading
  ...
  dangerouslySetInnerHTML={{
    __html: "This will render a subsection heading of text with the color set to red-500, and the font weight set to bold."
  }}
/>
