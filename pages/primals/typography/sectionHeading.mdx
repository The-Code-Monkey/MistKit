import { SectionHeading } from "@/primals";

# SectionHeading Component

The `SectionHeading` component is a functional component that returns a heading element with various style properties.

## Props

The `SectionHeading` component accepts the following props:
