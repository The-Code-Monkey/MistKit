...
<Text
  color="red-500"
  fontWeight="bold"
  dangerouslySetInnerHTML={{ __html: "This will render a paragraph of text with the color set to red-500, and the font weight set to bold." }}
>
</Text>
