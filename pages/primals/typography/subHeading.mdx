import { SubHeading } from "@/primals";

# SubHeading Component

The `SubHeading` component is a functional component that returns a subheading element with various style properties.

## Props

The `SubHeading` component accepts the following props:
...
<SubHeading
  ...
  dangerouslySetInnerHTML={{
    __html: "This will render a subheading of text with the color set to red-500, and the font weight set to bold."
  }}
/>
